...
import { MapPin, Calendar, Users, Grid2X2, IndianRupee} from "lucide-react"
        ...
        <div className='mt-10 container'>
          <Card className='flex flex-col justify-center w-full max-w-2xl mx-auto'>
            ...
            <CardContent className='grid '>
              ...
              <div className="space-y-1">
                <Label htmlFor="tickets">Tickets (Max 5)</Label>
                <Input id="tickets" type='number' placeholder='1' value={tickets} onChange={(e) => setTickets(parseInt(e.target.value))} min={1} max={5} required/> 
              </div>
            </CardContent>
